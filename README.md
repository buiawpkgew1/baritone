...
## 如何立即开始：
在聊天中键入 `#goto 1000 500`，即可传送至 x=1000 z=500。
键入 `#mine diamond_ore` 以开采钻石矿石。
键入 `#stop` 以停止操作。
如需更多信息，请阅读[使用说明页](USAGE.md)和/或观看这个[教程播放列表](https://www.youtube.com/playlist?list=PLnwnJ1qsS7CoQl9Si-RTluuzCo_4Oulpa)。
